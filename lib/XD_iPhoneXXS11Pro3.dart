...
class XD_iPhoneXXS11Pro3 extends StatelessWidget {
  XD_iPhoneXXS11Pro3({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(112.0, 0.0, 81.0, 22.0),
                          size: Size(312.0, 22.0),
                          pinTop: true,
                          pinBottom: true,
                          fixedWidth: true,
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 112.0, 38.0),
                    size: Size(112.0, 38.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(14.0, 10.0, 84.0, 17.0),
                    size: Size(112.0, 38.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'Text Field Light' (group)
                SizedBox(
              width: 271.0,
              height: 39.0,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 271.0, 28.0),
                    size: Size(271.0, 39.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.1, 38.5, 270.9, 0.5),
                    size: Size(271.0, 39.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Seperator' (group)
                        Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 270.9, 0.5),
                          size: Size(270.9, 0.5),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                  ...
                  Container(),
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(50.0, 9.0, 2.0, 21.0),
                    size: Size(271.0, 39.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Cursor' (group)
                        Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 2.0, 21.0),
                          size: Size(2.0, 21.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
                          child:
                              // Adobe XD layer: 'Cursor background' (shape)
                              Container(
                            color: const Color(0x00000000),
                          ),
                        ),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 11.0, 34.0, 17.0),
                    size: Size(271.0, 39.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 38.5, 270.9, 0.5),
                    size: Size(270.9, 39.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                  ...
                  Container(),
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(49.9, 9.0, 2.0, 21.0),
                    size: Size(270.9, 39.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(15.9, 11.0, 34.0, 17.0),
                    size: Size(270.9, 39.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
