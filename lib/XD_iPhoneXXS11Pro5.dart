...
class XD_iPhoneXXS11Pro5 extends StatelessWidget {
  XD_iPhoneXXS11Pro5({
    Key key,
  }) : super(key: key);
  @override
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(32.0, 56.0, 312.0, 23.0),
                  size: Size(375.0, 88.0),
                  pinLeft: true,
                  pinRight: true,
                  pinBottom: true,
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(112.0, 1.0, 78.0, 22.0),
                        size: Size(312.0, 23.0),
                        pinTop: true,
                        pinBottom: true,
                        fixedWidth: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.0, 44.0, 180.0, 44.0),
                  size: Size(375.0, 88.0),
                  pinLeft: true,
                  pinBottom: true,
                  fixedWidth: true,
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(26.0, 13.0, 33.0, 17.0),
                        size: Size(180.0, 44.0),
                        pinLeft: true,
                        fixedWidth: true,
                        fixedHeight: true,
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(6.0, 8.0, 18.0, 29.0),
                        size: Size(180.0, 44.0),
                        pinLeft: true,
                        fixedWidth: true,
                        fixedHeight: true,
                        child:
                            // Adobe XD layer: 'Chevron' (text)
                            Text(
                          '􀆉',
                          style: TextStyle(
                            fontFamily: 'SF Pro Text',
